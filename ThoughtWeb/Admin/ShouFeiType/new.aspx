<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new.aspx.cs" Inherits="ThoughtWeb.Admin.ShouFeiType._new" %>
...
<tr>
     <td class="table_input_item">
        ...
        <td class="table_input_content">
         <asp:textbox id="tbLeiXing" runat="server" width="250px" maxlength="100"></asp:textbox>
        </td>
         <td class="table_input_item">
            价格：
        </td>
        <td class="table_input_content">
            <asp:textbox id="tbJine" runat="server" width="250px" maxlength="100"></asp:textbox>
        </td>
