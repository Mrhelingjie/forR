...
namespace Mejoy.WebSite.Admin
{
    public partial class Index : BaseAdmin
    {
        ...
        private void PageInit()
        {
            ...
            Response.Write("		<title>" + Common.Config.WEB_NAME + " - 停车场管理系统 [ver:" + Common.Config.WEB_VERSION + "]</title>\n");
            Response.Write("        <script language=\"javascript\">window.status=\"" + Common.Config.WEB_NAME + "--停车场管理系统[ver:" + Common.Config.WEB_VERSION + "]\"</script>");
            Response.Write("	</head>\n");
