<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new.aspx.cs" Inherits="ThoughtWeb.Admin.CheWeiNumber._new" %>
...
<tr>
     <td class="table_input_item">
        ...
        <td class="table_input_content" colspan="3">
         <asp:textbox id="tbCheWeiShu" runat="server" width="250px" maxlength="100"></asp:textbox>
        </td>
