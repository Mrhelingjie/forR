...
namespace ThoughtWeb.Admin.CheWeiNumber
{
    ...
    {
        Maticsoft.BLL.CheWeiNumber Bll = new Maticsoft.BLL.CheWeiNumber();
        ...
        private void CheckInput()
        {
            ...
            //DataSet ds = Maticsoft.DBUtility.DbHelperSQL.Query("Select * from BaoXiu where Status='报修'");
            //if (ds.Tables[0].Rows.Count > 0)
            //{
            //    this._Error = true;
            //    this._ErrorMsg = "已存在该房号，核对后输入！";
            //}
        }//End CheckInput()
