<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="ThoughtWeb.Admin.huiYuan.list" %>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="table_list">
    <tr>
        <td colspan="5" align="right">
            <input type="button" name="btn" class="btn" value="添加会员车" onclick="window.location.href='new.aspx?'+Math.random()">
        </td>
    </tr>
</table>
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="table_list">
    ...
    <asp:repeater id="rptList" runat="server">
			...
			<tr class="table_list_item">
				 <td>
                                 ...
                                 <td>
                                  <input type="button" name="btn" class="btn" value="编辑" onclick="listEvent('edit', '<%#Eval("ID")%>')"/>
                                 </td>
				 <td>
