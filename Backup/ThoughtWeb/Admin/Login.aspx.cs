...
namespace Mejoy.WebSite.Admin
{
    public partial class Login : BaseAdmin
    {
        ...
        private void VarInit()
        {
            ...
            //标题
            this.tdTitle.InnerHtml = string.Format("<strong>{0}  游泳馆信息管理系统</strong> <sub>{1}</sub>", Common.Config.WEB_NAME, Common.Config.WEB_VERSION);
        }
        ...
        private void UserLogin()
        {
            ...
            {
                _Password = GetMD5Hash(_Password);
                //登录
