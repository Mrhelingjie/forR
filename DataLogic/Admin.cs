...
{
    public class Admin : BaseDataLogic
    {
        /// <summary>
        /// 管理帐号编号
        /// </summary>
        ...
        {
            HttpCookie cookie = Context.Request.Cookies[Common.Config.COOKIE_ADMIN_LOGIN_KEY];
        ...
        public void CheckLogin(string lab)
        {
            ...
            if (Error)
            {
                Context.Response.Redirect(Common.Config.DIR_ADMIN + "login.aspx?do=logout&temp=." + DateTime.Now.Ticks.ToString());
